...
body {
background:transparent repeat scroll left top url('./themes/images/background/border/hex_pat.jpg');
}
.headercolumn {
...
.footercolumn {
background-color:#ffffff;border-top:1px solid #e6e6e6;border-right:0px;border-bottom:0px;border-left:0px;background:#ffffff none;
}
